...
class DocumentExportService:
    ...
    def export_normalized_docx(self) -> bytes:
        ...
        for block in all_blocks:
            ...
            if block.table_index is not None:
                ...
                for (r, c), cell_blocks in cell_content.items():
                    ...
                    for tb in cell_blocks:
                        ...
                        # Critical: same RTL logic as your working code
            ...
            # Non-table content
            if b_type == "heading":
                p = doc.add_heading(text, level=block.heading_level or 1)
            else:
